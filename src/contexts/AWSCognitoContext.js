...
export const AWSCognitoProvider = ({ children }) => {
                ...
                dispatch({
                    ...
                    payload: {
                        ...
                        user: {
                            ...
                            id: session.getIdToken().payload['custom:id']
                        }
                    }
                });
                localStorage.setItem('accessToken', session.getAccessToken().getJwtToken());
                localStorage.setItem('email', authData.getUsername());
                localStorage.setItem('name', session.getIdToken().payload.name);
                localStorage.setItem('id', session.getIdToken().payload['custom:id']);
            },
            onFailure: () => {},
    ...
    const register = (email, password, name, id) =>
